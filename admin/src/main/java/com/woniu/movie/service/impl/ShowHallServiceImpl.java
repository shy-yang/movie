...
public class ShowHallServiceImpl implements IShowHallService {
    ...
    @Override
    public List<ShowHall> findAllByShowSiteId(ShowHallQueryVo queryVo) {
        return showHallMapper.selectAllByShowSiteId(queryVo);
    }

    @Override
    public List<ShowHallVo> findShowHallVosByShowHallQueryVo(ShowHallQueryVo showHallQueryVo) {
        return showHallMapper.selectShowHallVosByShowHallQueryVo(showHallQueryVo);
    }

    @Override
    public int batchModifyShowHallStateByShowHallIds(String[] showHallIds, String showHallState) {
        return showHallMapper.batchUpdateShowHallStateByShowHallIds(showHallIds, showHallState);
    }
